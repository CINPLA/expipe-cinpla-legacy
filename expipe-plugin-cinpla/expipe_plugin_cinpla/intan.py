...
class IntanPlugin(IPlugin):
    ...
    def attach_to_cli(self, cli):
        ...
        def process_intan(action_id, prb_path, pre_filter,
                               ...
                               split_probe, no_local, intanephys_path,
