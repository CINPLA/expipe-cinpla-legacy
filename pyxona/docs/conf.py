...
# -*- coding: utf-8 -*-
#
# pyxona documentation build configuration file, created by
...
release = pyxona.__version__.replace("v", "")
...
latex_documents = [
    (master_doc, 'pyxona.tex', 'pyxona Documentation',
...
man_pages = [
    (master_doc, 'pyxona', 'pyxona Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'pyxona', 'pyxona Documentation',
     author, 'pyxona', 'One line description of project.',
     'Miscellaneous'),
]
